        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (listBox1.SelectedIndex < 0 || listBox1.SelectedIndex >= listBox1.Items.Count)
            {
                ...
                try
                {
                    ...
                    insertCommand.Parameters.AddWithValue("@patientId", patient_id);
                    insertCommand.Parameters.AddWithValue("@doctorId", account_id);
                    ...
                    newPrescriptionId = Convert.ToInt32(insertCommand.ExecuteScalar());
